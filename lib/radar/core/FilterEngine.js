...
// ============================================================
// RadarAZ v20.1 - Filter Engine (مع اختبار استدعاء filter)
// ============================================================
...
export class FilterEngine {
  ...
  // ✅ هذا هو المكان الحاسم - تم إضافة سجلي التأكيد هنا
  static filter(universe, options = {}) {
    // ✅ سجل التأكيد الأول
    console.log("🔥 ENTER FILTER()");
    
    // ✅ رمي خطأ للتأكيد الثاني
    throw new Error("FILTER ENGINE TEST");

    // الكود التالي لن يتم تنفيذه (لن يصل إليه بسبب الـ throw)
