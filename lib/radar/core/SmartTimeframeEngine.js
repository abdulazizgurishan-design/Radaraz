...
// ============================================================
// RadarAZ v20.1 - Smart Timeframe Engine (نهائي)
// ============================================================
// ✅ يمنع استخدام 1 و 5 دقائق تماماً
// ✅ أصغر فريم هو 15 دقيقة
// ============================================================
...
export class SmartTimeframeEngine {
  static getTimeframe(stock, atrPercent = 0) {
    ...
    // ✅ الشرط الأول: نشط جداً (يستخدم 15 بدلاً من 1)
    ...
    // ✅ الشرط الثاني: نشط (يستخدم 15 بدلاً من 5)
