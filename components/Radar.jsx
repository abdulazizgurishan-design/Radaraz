    ...
    <div style={{
      ...
      <header style={{ textAlign: 'center', marginBottom: '30px', paddingTop: '15px' }}>
        ...
        <p style={{ color: '#8892b0', fontSize: '0.9rem', margin: '0' }}>
          رادار مسح السوق الأمريكي اللحظي الآمن (تحت 500 مليون$)
        </p>
      </header>
      ...
      {/* لوحة الجدول المدمجة لعدم حدوث قص على شاشات الجوال */}
      <div style={{
        maxWidth: '1200px',
        margin: '0 auto',
        background: '#111827',
              ...
              <tbody style={{ fontSize: '0.85rem' }}>
                {stocks.map((stock, idx) => (
                  <tr key={idx} style={{ 
                    ...
                    <td style={{ padding: '12px 8px', fontWeight: 'bold', color: stock.signal && stock.signal.includes('🔥') ? '#ff4d4d' : '#38bdf8' }}>
                      {stock.signal || "عالي ⚡"}
                    </td>
      ...
      {/* الملاحظات أسفل الصفحة بخط صغير مدمج ومحدث */}
